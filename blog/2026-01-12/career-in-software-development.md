...
* College years and immediately after (1991-1998)
* Client server applications (1998-2005)
* Web applications (2005-2014)
* Library-land (2014-present)
...
### Library-land (2014-present)
Around 2011 I started to get curious about what software development outside the Microsoft stack looked like<sup>1</sup>. After a few years playing around with Ruby in my spare time, in 2014 I took a full time job as a Ruby developer. This job was at the Penn State University Library and I took it because they were working on Ruby and that's what I was interested in doing at that time. Little did I know that this job was going to change my career trajectory in a big way.
...
I wrote this post based on the materials that I used a couple of years ago when I gave a presentation to a few Computer Science (CS) undergrads about my career story, and therefore my story starts during the years that I pursued my CS degree<sup>5</sup>.
...
## Notes
[1] I wrote about [my first experiences with Ruby in 2011](https://hectorcorrea.com/blog/2011-01-24/ruby-development-on-the-mac-os-x) and about my [journey as a Ruby developer in 2019](https://hectorcorrea.com/blog/2019-11-18/my-strange-journey-to-becoming-a-ruby-developer).

[2] If you look around the [topics in my blog](https://hectorcorrea.com/blog) you'll notice how my interests have shifted over time. There are posts about technologies that no longer exist or that I don't use anymore. Or this [article that I wrote in 2003](https://www.codemag.com/Article/0307061/Auto-Deploying-Windows-Forms-.NET-Applications-The-Revenge-of-the-Fat-Client) on how to deploy applications over the wire, so quaint, err, I mean so obsolete.

[3] If this is news to you I recommend the books [Algorithms of Oppression: How Search Engines Reinforce Racism](https://en.wikipedia.org/wiki/Algorithms_of_Oppression) by Safiya Noble and [Race After Technology](https://en.wikipedia.org/wiki/Race_After_Technology) by Ruha Benjamin on the subject. The piece [Knowing Algorithms](https://digitalsts.net/wp-content/uploads/2019/11/26_digitalSTS_Knowing-Algorithms.pdf) by Nick Seaver in *digitalSTS: A Field Guide for Science & Technology Studies* is also a good place to start.

[4] There is a reason Felienne Hermans wrote [A Case for Feminism in Programming Language Design](https://www.felienne.com/wp-content/uploads/2024/10/Feminism_in_Programming_Language_Design_CR_5-1.pdf) and Charlton D. McIlwain wrote about the erasure of the contributions by African Americans to computing and the internet in [Black Software](https://en.wikipedia.org/wiki/Black_Software).

[5] The slides for that presentation are available [here](https://hectorcorrea.com/downloads/2023-career-story.pdf).